...
int main(){
    ...
    auto matChao = std::make_shared<lambertian>(cor(0.2, 0.3, 0.4));
    auto matCen = std::make_shared<lambertian>(cor(0.7, 1, 0.3));
    auto matEsq   = std::make_shared<dieletrico>(1.5);
    auto matDir  = std::make_shared<metal>(cor(0.8, 0.6, 0.2), 0);
